...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    # Install  required dependencies for Dlib
    sudo -H apt-get -y install build-essential cmake
    sudo -H apt-get -y install libopenblas-dev liblapack-dev
    sudo -H apt-get -y install libx11-dev libgtk-3-dev
    sudo -H apt-get -y install python python-dev python-pip
    sudo -H apt-get -y install python3 python3-dev python3-pip
